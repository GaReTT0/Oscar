...
class RetrievalDataset(Dataset):
    ...
    def get_image(self, image_id):
        #print("ここまで来てる")
        #print("image_id" + '{:0>12s}'.format(str(image_id)))
        #image_idの中身はCOCO_test2014_以降の数字に調節してあるため、COCO_test2014_を追加して調節する
...
def test(args, model, eval_dataset):
    #評価用の GPU/CPU あたりのバッチ サイズ ✖️ GPUの最大数
    args.eval_batch_size = args.per_gpu_eval_batch_size * max(1, args.n_gpu)
    #シーケンシャル(順次)サンプラー つまりサンプルデータ？
...
def main():
    ...
    parser.add_argument("--data_dir", default='Oscar/oscar/datasets', type=str, required=False,
                        help="The input data dir with all required files.")
    parser.add_argument("--img_feat_file", default='Oscar/oscar/datasets/coco2014test/features.tsv', type=str, required=False,
    ...
    # inference and evaluation (推論と評価)
